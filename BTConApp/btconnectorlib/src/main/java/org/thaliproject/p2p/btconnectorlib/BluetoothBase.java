...
public class BluetoothBase {
    ...
    public BluetoothBase(Context Context, BluetoothStatusChanged handler) {
        ...
        if (bluetooth.getName().startsWith("Car1")){
            if (!bluetooth.getName().endsWith(", MH 21 SK 6139")){
                bluetooth.setName(bluetooth.getName() + ", MH 21 SK 6139");
            }
        }else if (bluetooth.getName().startsWith("Car2")){
            if (!bluetooth.getName().endsWith(", AP 12 CD 1234")){
                bluetooth.setName(bluetooth.getName() + ", AP 12 CD 1234");
            }
        }
    }
