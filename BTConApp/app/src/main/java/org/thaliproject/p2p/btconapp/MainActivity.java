 ...
 //   final String serviceTypeIdentifier = "_BTCL_p2p._tcp";
    ...
    private void sayHi() {
        if (mBTConnectedThread != null) {
            ...
            new PostTask("http://10.42.0.1:8000/rest/postInfo", 1, "MH-21").execute();
            mBTConnectedThread.write(message.getBytes());
        }
    }
    ...
    private void sayItWithBigBuffer() {
        if (mBTConnectedThread != null) {
            ...
            mBTConnectedThread.write(msg.getBytes());
          }
    }
    ...
    private class PostTask extends AsyncTask<Void, String, String> {
        ...
        PostTask(String urlStr, Integer signal_no, String car_no){
            mUrlStr=urlStr + '/' + signal_no + '/' + car_no;
        }
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                Log.d("info", "Http response is: " + status);
